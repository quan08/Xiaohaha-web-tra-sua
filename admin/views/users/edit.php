...
<body>
    ...
    ?>
    <div class="container">
        <a class="btn btn-success" href="users">Quản lý khách hàng</a>
        <a class="btn btn-success" href="staff">Quản lý nhân viên</a>
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="form-control ">
                        <input type="radio" class="" value=1 required name="kichhoat"> Khách hàng
                        <input type="radio" class="" value=2 required name="kichhoat"> Nhân viên
                    </div>
                </div>
            </div>
        </form>
